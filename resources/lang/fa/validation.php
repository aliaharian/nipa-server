    ...
    */
    ...
    'custom' => [
        ...
        'factor_payment_steps' => [
            'allHavePrice' => "برای تعریف مراحل پرداخت ابتدا باید قیمت همه ی محصولات را تعریف کنید",
            'count0' => "هیچ مرحله پرداختی تعریف نشده است",
            'count1' =>  "قیمت قابل پرداخت مجموع مراحل با قیمت کل فاکتور برابر نیست",
            'count2' => "قیمت قابل پرداخت مجموع مراحل با قیمت کل فاکتور برابر نیست"
        ],
    ],
